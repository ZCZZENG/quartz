...
I'm using Hetzners Dedicated Servers to Setup Nodes in my Proxmox Datacenter.

For everything going into our Server, except Services like the Proxmox Dashboard and SSH server we are going to route through a firewall, in my case [[OPNsense]].